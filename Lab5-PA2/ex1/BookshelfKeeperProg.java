...
public class BookshelfKeeperProg {
     ...
     */
    public static void checkAscendingOrder(ArrayList<Integer> pileOfBooks) {
     ...
     */
    public static void checkHeight(ArrayList<Integer> pileOfBooks) {
     ...
     */
    public static void checkBounds(int height, BookshelfKeeper bookshelfKeeper) {
     ...
     */
    public static void checkBookHeight(int height) {
        if (height < 0) {
            System.out.println("ERROR: Height of a book must be positive.");
            System.out.println("Exiting Program.");
            System.exit(0);
     ...
     */
    public static void errorCheckBooks(ArrayList<Integer> pileOfBooks) {
     ...
     */
    public static void runBatchMode(Scanner in, BookshelfKeeper bookshelfKeeper) {
